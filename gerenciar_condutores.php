...
// Agrupa os veículos por condutor
$veiculos_map = [];
...
<head>
    ...
    <title>RAV Admin - Gerenciar Condutores</title>
...
<body class="light-mode section-bg-gray d-flex flex-column min-vh-100">
        ...
        <div class="container flex-column flex-lg-row">
            <div class="collapse navbar-collapse w-100" id="adminNavbar">
                ...
                <ul class="navbar-nav w-100 d-flex flex-lg-row gap-lg-1 py-1 py-lg-0 ms-lg-n3">
                    ...
                    <li class="nav-item">
                        <a href="gerenciar_condutores.php" class="nav-link text-white fw-medium px-4 py-3 active"><i class="bi bi-people-fill me-2 me-lg-1"></i>Condutores</a>
                    </li>
                    <li class="nav-item">
    ...
    <main class="container py-4 flex-grow-1">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
            <div>
                <h2 class="text-dark mb-1 fw-bold"><i class="bi bi-person-vcard text-primary me-2"></i>Gestão de Condutores</h2>
                <p class="text-secondary small mb-0">Pesquise, edite e adicione veículos a condutores cadastrados no sistema.</p>
            </div>
            <div class="bg-white px-4 py-2 rounded shadow-sm border text-center">
                ...
                <span class="fs-4 fw-bold text-primary"><?= count($condutores) ?> <i class="bi bi-people ms-1 fs-5"></i></span>
            </div>
        </div>
        ...
        <div class="row mb-4">
            <div class="col-12 col-md-8 col-lg-6">
                <div class="input-group input-group-lg bg-white rounded border border-primary-subtle overflow-hidden shadow-sm">
                    ...
                    <input type="text" id="filtroCondutores" class="form-control border-0 custom-search text-dark" placeholder="Buscar por nome, CPF ou Código de Acesso...">
                </div>
            </div>
        </div>

        <!-- Grade de Condutores -->
        <div class="row row-cols-1 row-cols-md-2 row-cols-xl-3 g-4" id="gridCondutores">
            <?php foreach ($condutores as $c): ?>
            <?php $veiculos = $veiculos_map[$c['id']] ?? []; ?>
            <div class="col condutor-item">
                <div class="card h-100 condutor-card bg-white rounded-3">
        ...
        <div id="noResultsMsg" class="text-center py-5 d-none">
            <h5 class="text-secondary fw-bold"><i class="bi bi-search me-2"></i>Nenhum condutor encontrado para esta busca.</h5>
        </div>
    </main>

    <!-- Modal Editar Condutor -->
    <div class="modal fade" id="modalEditarCondutor" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-primary"><i class="bi bi-pencil-square me-2"></i>Editar Condutor</h5>
            ...
            <div class="modal-content border-top border-4 border-primary shadow-lg">
                ...
                <div class="modal-body p-4">
                    <div class="mb-3 border-bottom pb-2">
                        ...
                        <strong class="text-dark" id="add_nome_condutor">Nome Here</strong>
                    </div>
    ...
    <script>
        ...
        const condutoresList = document.querySelectorAll('.condutor-item');
        ...
        const modalEdit = new bootstrap.Modal(document.getElementById('modalEditarCondutor'));
        ...
        btnAddVeiculos.forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                document.getElementById('add_nome_condutor').textContent = this.getAttribute('data-nome');
                modalAdd.show();
            });
        });
