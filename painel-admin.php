        ...
        <div class="container py-3 d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center gap-3">
                ...
                <button class="btn btn-outline-secondary d-lg-none" type="button" data-bs-toggle="collapse"
                    data-bs-target="#adminNavbar" aria-expanded="false" aria-controls="adminNavbar">
                    <i class="bi bi-list fs-4"></i>
                </button>
                <a href="<?= (isset($_SESSION['acesso']) && $_SESSION['acesso'] === 'portaria') ? 'estacionamento.php' : 'painel-admin.php' ?>"
                    ...
                    <h1 class="logo-text m-0 fw-bold d-flex align-items-center">
                        ...
                        <span class="badge bg-cps-red text-white font-monospace ms-2 mt-2"
                            style="font-size: 0.70rem;"><?= (isset($_SESSION['acesso']) && $_SESSION['acesso'] === 'portaria') ? 'Portaria' : 'Admin' ?></span>
                    </h1>
                </a>
            </div>
            <div class="d-flex align-items-center gap-2">
                <div class="dropdown">
                    <button class="btn btn-light rounded-pill border d-flex align-items-center gap-2" type="button"
                        data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="bi bi-person-badge-fill fs-5 text-cps-red"></i>
                        <span
                            class="d-none d-md-inline fw-medium text-dark small"><?= htmlspecialchars($_SESSION['usuario_nome'] ?? 'Gestor') ?></span>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-end shadow border-0 mt-2">
                        <li>
                            <h6 class="dropdown-header"><?= htmlspecialchars($_SESSION['etec_nome'] ?? 'Guarita - ETEC') ?></h6>
                        </li>
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item text-danger fw-bold" href="sair.php"><i
    ...
    <nav class="navbar navbar-expand-lg nav-cps p-0" style="z-index: 1010;">
        <div class="container flex-column flex-lg-row">
            <div class="collapse navbar-collapse w-100" id="adminNavbar">
                ...
                <div
                    class="d-md-none bg-dark p-3 text-white d-flex justify-content-between align-items-center mb-2 mx-3 mt-3 rounded border">
                    <span class="small fw-bold">Acessibilidade:</span>
                    <div class="d-flex gap-3">
                        <button type="button" class="btn btn-sm text-white p-0 fw-bold"
                            id="btn-decrease-font-mobile">A-</button>
                        <button type="button" class="btn btn-sm text-white p-0 fw-bold"
                            id="btn-increase-font-mobile">A+</button>
                        <button type="button" class="btn btn-sm text-white p-0" id="btn-toggle-contrast-mobile"><i
                ...
                <ul class="navbar-nav w-100 d-flex flex-lg-row gap-lg-1 py-1 py-lg-0 ms-lg-n3">
                    <li class="nav-item">
                        <a href="painel-admin.php" class="nav-link text-white fw-medium px-4 py-3 active"><i
                                class="bi bi-house-door me-2 me-lg-1"></i>Painel Inicial</a>
                    </li>
                    <li class="nav-item">
                        <a href="acessos.php" class="nav-link text-white fw-medium px-4 py-3"><i
                                class="bi bi-speedometer2 me-2 me-lg-1"></i>Acessos Rápidos</a>
                    </li>
                    <li class="nav-item">
                        <a href="estacionamento.php" class="nav-link text-white fw-medium px-4 py-3"><i
                                class="bi bi-car-front-fill me-2 me-lg-1"></i>Estacionamento</a>
                    </li>
                    <li class="nav-item">
                        <a href="gerenciar_cadastros.php" class="nav-link text-white fw-medium px-4 py-3"><i
                                class="bi bi-people-fill me-2 me-lg-1"></i>Cadastros</a>
                    </li>
                    <li class="nav-item">
                        <a href="relatorios.php" class="nav-link text-white fw-medium px-4 py-3"><i
                                class="bi bi-bar-chart-line me-2 me-lg-1"></i>Relatórios</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <main class="container py-4">
            ...
            <div class="col-12">
                <div class="position-relative">
                    <div class="input-group input-group-lg custom-search">
                        ...
                        <input type="text" class="form-control" id="buscaGeral" placeholder="Placa, Veículo, Nome..."
                            autocomplete="off">
                        <button
                            class="btn btn-outline-secondary border-0 bg-transparent position-absolute end-0 top-50 translate-middle-y me-2 d-none"
                            type="button" id="btnLimparBusca" style="z-index:5;">
                            <i class="bi bi-x-lg text-secondary"></i>
                        </button>
                    </div>
                    <!-- Painel de Resultados da Busca -->
                    <div id="painelResultadosBusca"
                        class="busca-resultado-painel d-none shadow-lg border-0 rounded-3 overflow-hidden">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row g-4 align-items-stretch">
            <div class="col-12 col-lg-6">
                ...
                <div
                    class="card bg-dark-card border-success-subtle mb-4 shadow-lg h-100 d-flex flex-column prancheta-card">
                    ...
                    <div class="card-body p-4 flex-grow-1" style="min-height: 0; overflow-y: auto;">
                        ...
                        <div class="row g-2 mb-3 pb-3 border-bottom align-items-stretch">
                            <div class="col-12 mb-3">
                                <span
                                    class="d-inline-block px-3 py-2 rounded-pill fw-bold bg-primary text-white shadow-sm"
                                    style="font-size: 0.85rem; letter-spacing: 0.5px;">
                                    <i class="bi bi-person-badge-fill me-2"></i> Acesso de cadastrados
                                </span>
                            </div>
                            <div class="col-8 col-md-8">
                                <input type="text" id="busca_rapida"
                                    class="form-control border-primary-subtle h-100 shadow-sm" data-mask="cpf-id"
                                    placeholder="Busca Rápida: CPF ou ID (7 dígitos)">
                            </div>
                            <div class="col-4 col-md-4">
                                <button type="button" id="btnAbrirModal"
                                    class="btn btn-primary w-100 h-100 d-flex justify-content-center align-items-center gap-2 px-1 shadow-sm rounded-pill"
                                    data-bs-toggle="modal" data-bs-target="#modalCadastro"
                                    title="Cadastrar Conduzinte Oficial">
                                    <i class="bi bi-person-plus-fill"></i><span
                                        class="d-none d-md-inline fw-bold small">Novo Cadastro</span>
                                </button>
                            </div>
                        ...
                        <div class="mb-4 mt-2">
                            <span
                                class="d-inline-block px-4 py-2 rounded-pill fw-bold bg-acesso-comum text-white shadow-sm"
                                style="font-size: 0.9rem; letter-spacing: 0.5px;">
                                <i class="bi bi-speedometer2 me-2"></i>Acesso rápido
                            </span>
                        </div>
                        <form action="registrar_acesso.php" method="POST" class="row g-2 form-registrar-acesso">
                            <div class="col-12 d-flex align-items-end flex-wrap mb-2">
                                ...
                                <div class="placa-inline" id="wrapperPlaca">
                                    <label class="form-label small fw-bold label-required" id="labelPlacaRequired">Placa
                                        :</label>
                                    <input type="text" id="placa" name="placa" class="form-control" data-mask="placa"
                            ...
                            <div class="col-12" id="camposAlunoDinamico">
                                <div class="row g-2">
                                    <div class="col-4">
                                        ...
                                        <select id="curso_aluno" name="curso_aluno" class="form-select"
                                            style="border-radius: 20px;">
                                    ...
                                    <div class="col-4">
                                        ...
                                        <select id="modulo_aluno" name="modulo_aluno" class="form-select"
                                            style="border-radius: 20px;">
                                            <option value="">Selecione...</option>
                                        </select>
                                    </div>
                                    <div class="col-4">
                                        ...
                                        <select id="periodo_aluno" name="periodo_aluno" class="form-select"
                                            style="border-radius: 20px;">
                                            <option value="">Selecione...</option>
                            ...
                            <div class="col-6">
                                ...
                                <input type="tel" name="contato_valor" id="inputContato" class="form-control"
                                    data-mask="tel" placeholder="(00) 00000-0000" style="border-radius: 20px;">
                            </div>
                                ...
                                <div class="d-flex gap-3 mb-2 position-relative">
                                    <div class="flex-grow-1 position-relative">
                                        ...
                                        <div id="balaoObsHint" class="obs-hint-balloon d-none">
                                            <i class="bi bi-lightbulb-fill me-1"></i> Recomenda-se adicionar uma
                                            observação
                                        </div>
                                    </div>
                                    <button type="submit" class="btn btn-success flex-grow-1 fw-bold py-2"
                                        style="background-color: #157347; border: none; border-radius: 20px; font-size: 0.95rem;">
                                        Registrar acesso
                                    </button>
                                </div>
            ...
            <div class="col-12 col-lg-6">
                <div
                    class="card bg-dark-card border-danger-subtle mb-4 shadow-lg h-100 d-flex flex-column prancheta-card">
                    <div class="card-header bg-danger text-white text-center py-2 fw-bold flex-shrink-0">Registrar saída
                    </div>
                    ...
                    <div class="px-3 py-2 bg-light border-bottom border-danger-subtle">
                        <div class="input-group">
                            ...
                            <input type="text" id="filtroTextoSaida" class="form-control border-start-0 shadow-none"
                                placeholder="Buscar por placa ou nome do condutor...">
                        </div>
                    </div>
                        ...
                        <div id="listaSaidaVeiculos" class="list-group list-group-flush custom-scrollbar">
                            <?php if (count($veiculosDentro) > 0): ?>
                                <?php foreach ($veiculosDentro as $reg): ?>
                                    <div class="list-group-item d-flex justify-content-between align-items-center p-3 item-saida"
                                        ...
                                        <div>
                                            <h6 class="mb-0 fw-bold placa-saida" style="color: var(--cps-red);">
                                        
                                                <?= $reg['placa'] ?></h6>
                                            <span class="info-condutor d-block"><?= htmlspecialchars($reg['nome_condutor']) ?> —
                                                Dentro:
                                                <?= date('H:i', strtotime($reg['data_hora_entrada'])) ?></span>
                                        </div>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-primary"><i class="bi bi-person-plus-fill me-2"></i>Cadastro Completo
                    </h5>
                ...
                <div class="modal-body p-4">
                    <form action="processa_cadastro.php" method="POST">
                        <div class="mb-4">
                            <h6 class="pb-2 mb-3 text-primary border-bottom border-primary"
                            ...
                            <div class="row g-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" id="modalNomeCondutor" name="nome_completo" class="form-control">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label small fw-bold">CPF</label>
                                    <input type="text" id="modalCPF" name="cpf" class="form-control" data-mask="cpf"
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row g-3">
                                <div class="col-md-4">
                                    ...
                                    <select id="modalTipoVeiculo" name="tipo_veiculo" class="form-select">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" id="modalPlacaVeiculo" name="placa" class="form-control"
                                        data-mask="placa" placeholder="AAA-0000" required>
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label small">Marca/Modelo</label>
                                    <input type="text" id="modalModelo" name="modelo_veiculo" class="form-control">
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label small">Cor</label>
                                    <input type="text" id="modalCor" name="cor_veiculo" class="form-control">
                                </div>
                            </div>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function updateFontIndicators() {
                ...
                document.querySelectorAll('.font-scale-badge').forEach(el => el.textContent = pct);
            }
            updateFontIndicators();

            function increaseFont() {
                if (currentScale < maxScale) {
                    currentScale = Math.min(maxScale, parseFloat((currentScale + 0.1).toFixed(1)));
                    document.documentElement.style.setProperty('--font-scale', currentScale);
            ...
            function decreaseFont() {
                if (currentScale > minScale) {
                    currentScale = Math.max(minScale, parseFloat((currentScale - 0.1).toFixed(1)));
                    document.documentElement.style.setProperty('--font-scale', currentScale);
                    localStorage.setItem('fontScale', currentScale.toFixed(1));
                    updateFontIndicators();
                }
