-- Active: 1774996034755@@127.0.0.1@3306@mysql
...
-- Tabela para armazenar as submissões de formulário da página de Contato.
...
CREATE TABLE veiculos (
    ...
    tipo_veiculo ENUM('Carro', 'Moto', 'Outros') DEFAULT 'Carro', -- Detalhamento do rav2
    obs TEXT NULL,
    id_empresa INT NOT NULL,
